...
@section('content')
<div class="container mt-5" x-data="{ openMenu: null }">
        ...
        <div class="flex justify-between items-center mb-2">
            ...
            <div class="relative inline-block text-left">
                <button type="button" class="text-gray-500 hover:text-gray-800 focus:outline-none"
                    @click="openMenu = openMenu === 'discussion-{{ $discussion->id }}' ? null : 'discussion-{{ $discussion->id }}'">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
                <div x-show="openMenu === 'discussion-{{ $discussion->id }}'" @click.away="openMenu = null"
                ...
                <div>
                    ...
                    <div class="replies pl-3">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="relative inline-block text-left">
                                <button type="button" class="text-gray-500 hover:text-gray-800 focus:outline-none"
                                    @click="openMenu = openMenu === 'reply-{{ $reply->id }}' ? null : 'reply-{{ $reply->id }}'">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div x-show="openMenu === 'reply-{{ $reply->id }}'" @click.away="openMenu = null"
                                    class="absolute right-0 z-10 mt-2 w-48 bg-white rounded-md shadow-lg">
