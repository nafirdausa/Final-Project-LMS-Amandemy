{{-- resources/views/user_guru/edit_ujian.blade.php --}}
        ...
        <div class="flex-none max-w-full px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-indigo-200 border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="p-6 pb-0 mb-0 bg-blue border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <form action="{{ route('dashboard.guru.update_ujian', $ujian->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <h1 class="flex align-items justify-center text-base font-bold leading-7 text-black py-4" style="font-size: 25px;">EDIT UJIAN</h1>
                        <div class="space-y-12">
                            <div class="border-b border-gray-900/10 pb-12">
                                <div class="sm:col-span-3">
                                    <label for="judul" class="block text-sm font-medium leading-6 text-black font-semibold">Judul Ujian</label>
                                    <div class="mt-2">
                                        <input type="text" name="judul" id="judul" value="{{ $ujian->judul }}" autocomplete="given-name" class="block w-full rounded-lg border py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <textarea id="deskripsi" name="deskripsi" rows="3" class="block w-96 rounded-lg border py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $ujian->deskripsi }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="relative max-w-sm">
                                        ...
                                        <input type="date" name="deadline" id="deadline" value="{{ $ujian->deadline }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                                    </div>
                                </div>                   
                                <div class="mt-4">
                                    <label for="time" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select time</label>
                                    <div class="relative">
                                        <input type="time" id="time" name="time" value="{{ $ujian->time }}" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="00:00" required />
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <p class="text-sm text-gray-600 mt-2">File saat ini: <a href="{{ asset('storage/ujian/' . $ujian->file) }}" target="_blank" class="text-blue-500">{{ $ujian->file }}</a></p>
                                    </div>
                                </div>
