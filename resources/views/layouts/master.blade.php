...
<body class="font-sans text-gray-800">
    ...
    {{-- <header class="flex justify-between items-center p-4 bg-white text-blue-900 shadow-md sticky top-0 z-50"> --}}
        <div class="text-2xl font-bold">
            <img src="{{asset('assets/img/studyroom.jpg')}}" alt="logo" width="180" height="180">
        </div>
        <nav class="flex items-center text-white">
            @auth
                <a href="{{ route('user_siswa.home') }}" class="mr-4 text-gray-600 hover:text-blue-700 fw-semibold active:text-blue-700">Home</a>
                <a href="{{ route('dashboard.siswa.course') }}" class="mr-4 text-gray-600 hover:text-blue-700 fw-semibold active:text-blue-700">Course</a>
                <a href="{{ route('dashboard.siswa.report') }}" class="mr-4 text-gray-600 hover:text-blue-700 fw-semibold active:text-blue-700">Report</a>
                <a href="{{ route('dashboard.siswa.portofolio') }}" class="text-gray-600 hover:text-blue-700 fw-semibold active:text-blue-700">Portofolio</a>
            ...
            @else
                <a href="{{ route('user_siswa.home') }}" class="mr-4 text-gray-600 hover:text-blue-700 fw-bold active:text-blue-700 font-semibold">Home</a>
                <a href="{{ route('dashboard.siswa.course') }}" class="mr-4 text-gray-600 hover:text-blue-700 fw-bold active:text-blue-700 font-semibold">Course</a>
                <a href="{{ route('dashboard.siswa.report') }}" class="mr-4 text-gray-600 hover:text-blue-700 fw-bold active:text-blue-700 font-semibold">Report</a>
                <a href="{{ route('dashboard.siswa.portofolio') }}" class="text-gray-600 hover:text-blue-700 fw-bold active:text-blue-700 font-semibold">Portofolio</a>
                <div>
    ...
    <div class="pg-footer">
        <footer class="footer">
          ...
          <div class="footer-content">
            ...
            <div class="footer-content-column">
              <div class="footer-menu">
                <h2 class="footer-menu-name"> Pranala</h2>
            ...
            <div class="footer-content-column">
              <div class="footer-menu">
                <h2 class="footer-menu-name">Ikuti Kami</h2>
            ...
            <div class="footer-content-column">
              <div class="footer-call-to-action">
                <h2 class="footer-call-to-action-title">SMA Negeri Madesu</h2>
          ...
          <div class="footer-copyright">
            <div class="footer-copyright-wrapper">
              <p class="footer-copyright-text">
                <a class="footer-copyright-link" href="#" target="_self">Fakultas Teknik & Teknologi Informasi, Universitas Jendral Achmad Yani Yogyakarta @ 2018 - 2023.</a>
              </p>
            </div>
          </div>
        </footer>
